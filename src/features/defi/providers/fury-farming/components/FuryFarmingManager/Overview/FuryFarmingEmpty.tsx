...
export const FuryFarmingEmpty = ({
  assets,
  apy,
  onClick,
  opportunityName,
}: FuryFarmingEmptyProps) => {
  return (
    <DefiModalContent>
      <EmptyOverview
        assets={assets}
        footer={
          <Button width='full' colorScheme='blue' onClick={onClick}>
            <Text translation='defi.modals.furyFarmingOverview.cta' />
          </Button>
        }
      >
        <Stack spacing={1} justifyContent='center' mb={4}>
          <Text
            translation={[
              'defi.modals.furyFarmingOverview.header',
        ...
        <Text color='gray.500' translation='defi.modals.furyFarmingOverview.body' />
        <Text color='gray.500' translation='defi.modals.furyFarmingOverview.rewards' />
      </EmptyOverview>
    </DefiModalContent>
  )
}
