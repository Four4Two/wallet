...
const promoData: PromoItem[] = [
  {
    ...
    image: `url(https://uploads-ssl.webflow.com/5cec55545d0f47cfe2a39a8e/637d3eab8977b9c820ecb3fc_jinx-promo-1.jpg)`,
  ...
  {
    title: 'plugins.furyPage.dappBack.title',
    body: 'plugins.furyPage.dappBack.body',
    cta: 'plugins.furyPage.dappBack.cta',
