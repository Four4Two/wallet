...
export const BondProtocolCta = () => {
  ...
  return (
    <Card>
      <Card.Header>
        <Card.Heading>
          <Text translation='plugins.furyPage.bondProtocol.title' />
        </Card.Heading>
      </Card.Header>
      <Card.Body display='flex' gap={6} flexDirection='column'>
        <Text color='gray.500' translation='plugins.furyPage.bondProtocol.body' />
        <Button
          as={Link}
          ...
          onClick={handleClick}
        >
          {translate('plugins.furyPage.bondProtocol.cta')}
        </Button>
      </Card.Body>
    </Card>
  )
