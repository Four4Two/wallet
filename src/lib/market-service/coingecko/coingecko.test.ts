...
describe('CoinGecko market service', () => {
  describe('findAll', () => {
    ...
    const fury: CoinGeckoMarketCap = {
      id: 'shapeshift-fury-token',
      symbol: 'fury',
      name: 'ShapeShift FURY Token',
      image: 'https://assets.coingecko.com/coins/images/9988/large/FURY.png?1574330622',
    ...
    it('extract correct values for fury', async () => {
      const furyResult = {
        price: '0.162007',
        marketCap: '59502764',
        changePercent24Hr: 3.74881,
      ...
      mockedAxios.get.mockResolvedValue({ data: [fury] })
      const result = await coinGeckoMarketService.findAll()
      const foxAssetId = adapters.coingeckoToAssetIds('shapeshift-fury-token')[0]
      expect(result[foxAssetId!]).toEqual(furyResult)
    })
  })
  ...
  describe('findByAssetId', () => {
    ...
    it('should return market data for FURY', async () => {
      const result: MarketData = {
        price: '0.25007',
        marketCap: '59502764',
