...
export const Confirm: React.FC<ConfirmProps> = ({ onNext, accountId }) => {
  ...
  const handleDeposit = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: JinxDepositActionType.SET_TXID, payload: txid })
      ...
      dispatch({ type: JinxDepositActionType.SET_LOADING, payload: false })
    }
  }, [
    accountAddress,
    assetReference,
