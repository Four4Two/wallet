...
import {
  ...
  UNI_V2_FURY_STAKING_REWARDS_V3,
...
import furyClaim from './mockData/furyClaim'
import furyExit from './mockData/furyExit'
import furyStake from './mockData/furyStake'
import jinxClaimWithdraw from './mockData/jinxClaimWithdraw'
import jinxInstantUnstake from './mockData/jinxInstantUnstake'
import jinxStake from './mockData/jinxStake'
import jinxUnstake from './mockData/jinxUnstake'
...
const tokenMetadata: evm.TokenMetadata = {
  name: 'Jinx',
  description: 'The furyiest Fury',
  media: { url: 'http://jinx.fury', type: 'image' },
}
...
describe('parseTx', () => {
        ...
        transfers: [
          {
            ...
            assetId: 'eip155:1/erc20:0x595f0ce3e840fdcc0676cf522477b6b46a6bc734',
        ...
        transfers: [
          {
            type: TransferType.Send,
            from: address,
            to: UNI_V2_FURY_STAKING_REWARDS_V3,
            assetId: 'eip155:1/erc20:0x470e8de2ebaef52014a47cb5e6af86884947f08c',
    ...
    it('should be able to parse exit', async () => {
      ...
      const expected: ParsedTx = {
        ...
        transfers: [
          {
            type: TransferType.Receive,
            from: UNI_V2_FURY_STAKING_REWARDS_V3,
            to: address,
            assetId: 'eip155:1/erc20:0x470e8de2ebaef52014a47cb5e6af86884947f08c',
  ...
  describe('yearn', () => {
    ...
    it('should parse Yearn deposit to Blackfury router', async () => {
