          ...
          transfers: [
            {
              ...
              assetId: 'eip155:710/erc20:0xddafbb505ad214d7b80b1f830fccc89b60fb7a83',
              totalValue: '50920184',
          ...
          transfers: [
            {
              ...
              from: address,
              assetId: 'eip155:710/erc721:0x22c1f6050e56d2876009903609a2cc3fef83b415/6642412',
              totalValue: '1',
              components: [{ value: '1' }],
              id: '6642412',
              token: {
          ...
          transfers: [
            {
              ...
              from: address,
              assetId: 'eip155:710/erc1155:0xa67f1c6c96cb5dd6ef24b07a77893693c210d846/12857915',
              totalValue: '1',
              components: [{ value: '1' }],
              id: '12857915',
              token: {
  ...
  describe('erc20', () => {
    it('should be able to parse approve mempool', async () => {
      ...
      const expected: ParsedTx = {
        ...
        transfers: [],
        data: {
          assetId: 'eip155:710/erc20:0x4b1e2c2762667331bc91648052f646d1b0d35984',
          method: 'approve',
          parser: 'erc20',
