    ...
    <Card display='block' width='full'>
      <Card.Header>
        <Flex flexDirection='row' justifyContent='space-between' alignItems='center' mb={2}>
          <Text translation='plugins.furyPage.governanceTitle' fontWeight='bold' color='inherit' />
          <Link isExternal href={SNAPSHOT_BASE_URL} fontWeight='semibold' color={linkColor}>
            <Text translation='plugins.furyPage.seeAllProposals' />
          </Link>
        </Flex>
        <Text translation='plugins.furyPage.governanceDescription' color='gray.500' />
      </Card.Header>
      <Skeleton
